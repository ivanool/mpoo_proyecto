                        ...
                        switch (opcCuarto + 1) {
                            case 1 -> {
                                ...
                                for (int i = 0; i < h; i++) {
                                    ...
                                    Habitaciones sala = new Saladeestar("null",0);
                            ...
                            case 2 -> {
                                ...
                                for (int i = 0; i < h; i++) {
                                    ...
                                    Habitaciones cocina = new Cocina("null",0 );
                            ...
                            case 3 -> {
                                ...
                                for (int i = 0; i < h; i++) {
                                    ...
                                    Habitaciones dorm = new Dormitorio("null",0);
                            ...
                            switch (opcCuarto + 1) {
                                case 1 -> {
                                    ...
                                    for (int i = 0; i < h; i++) {
                                        ...
                                        DispositivosInteligentes dispositivo = Saladeestar.addDispositivosInteligentes(0);//////////////////Aqui es donde da el problema
                                ...
                                case 2 -> {
                                    ...
                                    for (int i = 0; i < h; i++) {
                                        ...
                                        DispositivosInteligentes dispositivo = cocina.agregarDispositivo();//////////////////Aqui es donde da el problema
                                        listaDispTot.add(dispositivo);
                                    }
                                }
                                case 3 -> {
                                    ...
                                    for (int i = 0; i < ji; i++) {
                                        ...
                                        DispositivosInteligentes dispositivo = dorm.agregarDispositivo(); //////////////////Aqui es donde da el problema
                                        listaDispTot.add(dispositivo);
                                    }
                                }
                ...
                case 3 -> {
                    if (!listaDispTot.isEmpty()) {
                        ...
                        for (DispositivosInteligentes dispositivo : listaDispTot) {
                            if (dispositivo.ID == IDdispositivo) {//////////////////Aqui no da error, pero como tal no se cual ID se uso de Dispositivos Inteligentes
                                dispositivo.apagar();
                            }
                        }
                    } else
